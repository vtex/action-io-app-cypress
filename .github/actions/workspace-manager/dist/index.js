...
function createContext({ account, workspace, authToken, }) {
    return {
        account,
...
function run() {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        const workspacesClient = (0, workspacesClient_1.createWorkspacesClient)({
            account,
            workspace: 'master',
            authToken,
        });
...
Object.defineProperty(exports, "__esModule", ({ value: true }));
exports.createWorkspacesClient = void 0;
const http = __importStar(__nccwpck_require__(255));
const context_1 = __nccwpck_require__(680);
const BASE_URL = 'https://platform.io.vtex.com';
class Workspaces {
    constructor(context) {
        this.context = context;
        this.client = new http.HttpClient('github-action/create-workspace', undefined, {
            headers: {
    ...
    create(account, workspace, production) {
        return __awaiter(this, void 0, void 0, function* () {
            yield this.client.postJson(`${BASE_URL}/${account}`, {
                name: workspace,
                production,
            });
        });
    ...
    delete(account, workspace) {
        return __awaiter(this, void 0, void 0, function* () {
            yield this.client.del(`${BASE_URL}/${account}/${workspace}`);
        });
    }
}
function createWorkspacesClient({ account, workspace, authToken, }) {
    const context = (0, context_1.createContext)({ account, workspace, authToken });
    return new Workspaces(context);
}
exports.createWorkspacesClient = createWorkspacesClient;
